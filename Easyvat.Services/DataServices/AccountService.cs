...
namespace Easyvat.Services.DataServices
{
    public class AccountService
    {
        ...
        public AccountService(EasyvatContext easyvatContext)
        {
        ...
        public async Task<bool> SaveUserDetails(UserDetailsModel model)
        {
            try
            {
                var userDet = _easyvatContext.Passports.FirstOrDefault(x => x.PassportNumber.ToUpper() == model.PassportNumber.ToUpper());
                if (userDet != null)
                {
