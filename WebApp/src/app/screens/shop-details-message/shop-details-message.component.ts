...
export class ShopDetailsMessageComponent implements OnInit {
  ...
  constructor(public modalPopup: MatDialogRef<ShopDetailsMessageComponent>, @Inject(MAT_DIALOG_DATA) public data: { name: string, address: string, city: string, Country: string, Phone: string }, public actionSheetController: ActionSheetController, private http: HttpClient) { }
